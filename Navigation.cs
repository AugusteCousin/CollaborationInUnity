...
namespace WasaaMP {
    public class Navigation : MonoBehaviourPunCallbacks {
        ...
        private bool hasCaughtHandle1, hasCaughtHandle2;
        ...
        void Start () {
            ...
            this.handle1=GameObject.Find("handle1").gameObject;
            this.handle2=GameObject.Find("handle2").gameObject;

            this.hasCaughtHandle1=false;
            this.hasCaughtHandle2=false;
        }
